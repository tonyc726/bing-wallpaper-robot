...
| ✅ 已上线 | **线上体检 a11y 4 项**(2026-08-15) | PR #4 已合并,线上复测 Lighthouse 四项全 100、53 通过 0 失败。详见 `sessions/2026-08-15-site-audit.md` |
| ✅ 已上线 | **P2 三项:chunk 版本校验 / LCP / DOM 瘦身**(2026-08-15) | 线上实测 LCP 1831→479ms、CLS 0.01;chunk 内嵌 `v` + 前端校验已生效。剩余观察项:等下一次 Action 的 `npm publish` 后,CDN 链恢复首发命中(过渡期走本站兜底,功能无损) |
